...
class UploadedFile implements UploadedFileInterface
{
     ...
     * Returns a normalized tree of UploadedFile instances or empty array if none are provided.
     */
    public static function createFromEnvironment(Environment $env): array
    {
        if (is_array($env['slender.files']) && $env->has('slender.files')) {
            return $env['slender.files'];
        } elseif (isset($_FILES)) {
     ...
     * Returns an array of normalized tree of UploadedFile instances.
     */
     ...
     * an exception.
     * Returns a Stream representation of the uploaded file.
     */
     ...
     * the file in the $_FILES array.
     *
     * Returns the filename sent by the client or null if none was provided.
     */
     ...
     * the file in the $_FILES array.
     *
     * Returns the media type sent by the client or null if none was provided.
     */
