...
class Uri implements UriInterface
{
     ...
     * Returns the URI authority, in "[user-info@]host[:port]" format.
     */
     ...
     * NOT be added.
     *
     * Returns the URI user information, in "username[:password]" format.
     */
     ...
     * percent-encoded.
     * Returns the RFC 3986 percent-encoded uri path.
