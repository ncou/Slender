...
class UriTest extends TestCase
{
    ...
    /**
     * @covers Slender\Http\Uri::withBasePath
     * @expectedException \TypeError
     */
    ...
    /**
     * @covers Slender\Http\Uri::createFromString
     */
    ...
    /**
     * @covers Slender\Http\Uri::createFromEnvironment
     * @ticket 1375
     */
    ...
    {
        $environment = \Slender\Http\Environment::mock([
            'SCRIPT_NAME' => '/index.php',
            'REQUEST_URI' => '/bar',
        ]);
        $uri = \Slender\Http\Uri::createFromEnvironment($environment);
