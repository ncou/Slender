...
class RequestTest extends TestCase
{
    ...
    /**
     * @covers Slender\Http\Request::createFromEnvironment
     */
    ...
    public function testCreateRequestWithInvalidMethodOther()
    {
        ...
        $req = new Request(10, $uri, $headers, $cookies, $serverParams, $body);
    }
    ...
    /**
     * @covers Slender\Http\Request::withUploadedFiles
     * @covers Slender\Http\Request::getUploadedFiles
     */
